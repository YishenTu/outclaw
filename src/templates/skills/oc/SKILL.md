...
Use the `oc` CLI to manage agents, control the daemon, rebuild the browser bundle, communicate across agents, start or resume coding sessions, inspect past sessions, and work with agent memory.
...
- When the user asks you to start background coding work in a repo or continue an existing coding session → [references/coding-sessions.md](references/coding-sessions.md)
